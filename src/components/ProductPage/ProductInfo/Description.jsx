...
const Description = ({
  ...
  return (
    <div className="relative overflow-hidden border-b-4 border-second-color py-6">
      ...
      <p className="mx-auto  mt-5 min-h-36 w-full rounded-3xl border-[9px] border-wood-color bg-main-color px-3 py-3 font-cairo text-sm font-bold !leading-7 tracking-wide text-white z-50 sm:w-[90%] sm:px-6 sm:py-6 sm:text-base">
        {description}
        {isUnAvailable && (
          <p className="mt-8 rounded-lg border-2 border-dashed border-red-300 py-2 px-3 text-right text-sm">
            {unAvailabilityNote}ddddddddddd
          </p>
        )}
      </p>
      <div className="flex flex-col-reverse items-center sm:flex-row">
        ...
        {items.length > 0 && (
          <div className="mr-auto flex w-[80%] -z-10 translate-x-9 flex-col items-end">
            <img
              src={Stikes}
              className="w-full  -translate-y-2 translate-x-6 sm:w-[50%]"
            />
