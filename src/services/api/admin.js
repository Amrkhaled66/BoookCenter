...
const updatePassword = async ({ data: userData }) => {
  const { data } = await axiosAdmin.post("/user/updatePassword", userData);
  return data;
};

const addNewCategory = async ({ sentData }) => {
...
const updateCategory = async ({ sentData, id }) => {
...
const addNewSubject = async ({ sentData }) => {
...
const updateSubject = async ({ sentData, id }) => {
...
const addNewSeller = async ({ sentData }) => {
...
const updateSeller = async ({ sentData, id }) => {
...
const addProduct = async ({ sentData }) => {
  const { data } = await axiosAdmin.post("/products/add", sentData);
  return data;
};

const updateProduct = async ({ sentData, id }) => {
...
const updateStock = async ({ sentData }) => {
...
const getProduct4AdminRequest = async ({ id }) => {
  const { data } = await axiosAdmin.get(`/products/admin/${id}`);
  return data;
};

const addManualOrder = async ({ sentData }) => {
